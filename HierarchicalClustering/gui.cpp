...
GUI_MainFrame::GUI_MainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_comboBox1 = new wxComboBox( m_panel1, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	...
	m_comboBox2 = new wxComboBox( m_panel1, wxID_ANY, wxT(""), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	m_comboBox2->Append( wxT("Pearson Correlation Centered") );
	m_comboBox2->Append( wxT("Pearson Correlation Uncentered") );
	m_comboBox2->Append( wxT("Pearson Correlation Centered Absolute") );
	m_comboBox2->Append( wxT("Pearson Correlation Uncentered Absolute") );
	...
	fgSizer11->Add( m_textCtrl1, 0, wxALL|wxEXPAND, 5 );

	bSizer3->Add( fgSizer11, 1, wxEXPAND, 5 );
	///////////////////////////////////
	///status window
	m_textCtrl2 = new wxTextCtrl( m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE|wxTE_READONLY );
